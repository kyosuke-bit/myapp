# -*- encoding: utf-8 -*-
# stub: amazing_print 1.4.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<rubocop>.freeze, ["~> 1.20"])
    s.add_development_dependency(%q<rubocop-rspec>.freeze, ["~> 2.4"])
  else
    ...
    s.add_dependency(%q<rubocop>.freeze, ["~> 1.20"])
    s.add_dependency(%q<rubocop-rspec>.freeze, ["~> 2.4"])
  end
end
